...
namespace Aryzon
{
    public class AryzonMainPoseDriver
    {
        ...
        void PerformUpdate()
        {
            ...
            if (Application.isPlaying)
            {
                ...
                AryzonSettings.Instance.aryzonManager.trackerPose = pose;
            }
#else
            AryzonPose pose = new AryzonPose();
            ...
            {
                pose.position = updatedPose.position.Value;
            }
            if (updatedPose.rotation.HasValue)
            {
                pose.rotation = updatedPose.rotation.Value;
            }
            AryzonSettings.Instance.aryzonManager.trackerPose = pose;
#endif
        }
